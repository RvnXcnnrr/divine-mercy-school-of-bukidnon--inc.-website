...
function Step({ number, title, description }) {
  return (
    <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200" data-reveal>
  ...
  return (
    <div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          <div data-reveal>
            ...
            <p className="mt-2 text-sm text-slate-600">Follow these steps to enroll.</p>
          </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl bg-brand-sky p-6 shadow-sm ring-1 ring-slate-200" data-reveal>
              ...
              <div className="mt-4 space-y-2">
                ...
                <NavLink
                  to="/contact#visit"
                  className="inline-flex w-full items-center justify-center rounded-md bg-white px-4 py-3 text-sm font-extrabold text-brand-goldText ring-1 ring-slate-200 transition-colors hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2"
                >
                  Schedule a visit
                </NavLink>
              </div>
      ...
      <section className="bg-brand-sky">
        <div className="mx-auto max-w-6xl px-4 py-14">
          <div className="rounded-2xl bg-slate-50 p-8 ring-1 ring-slate-200" data-reveal>
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-brand-sky text-brand-navy ring-1 ring-slate-200">
              ...
              <p className="mt-2 text-sm text-slate-600">Free transport support for learners living far from campus.</p>
            </div>
            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-brand-sky text-brand-navy ring-1 ring-slate-200">
              ...
              <p className="mt-2 text-sm text-slate-600">Helping families who cannot afford daily transportation.</p>
            </div>
            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-lg bg-brand-sky text-brand-navy ring-1 ring-slate-200">
              ...
              <p className="mt-2 text-sm text-slate-600">A dependable commute that supports attendance and peace of mind.</p>
            </div>
          </div>
          </div>
        </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200" data-reveal>
            ...
            <div className="mt-5 grid gap-3">
              {forms.map((form, idx) => (
                <a
                  key={`${form.label}-${idx}`}
                  className="inline-flex w-full items-center justify-between rounded-lg bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-800 ring-1 ring-slate-200 transition-colors hover:bg-brand-sky focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-2"
                  href={form.url}
                  download
                >
