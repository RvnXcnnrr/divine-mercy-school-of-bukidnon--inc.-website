...
export default function About() {
  ...
  function LoadingIndicator({ label }) {
    return (
      <div className="mt-4 inline-flex items-center gap-3 rounded-full bg-white/70 px-4 py-2 text-xs font-semibold text-slate-700 ring-1 ring-slate-200 shadow-sm backdrop-blur">
    ...
    <div>
      <section>
        <div className="mx-auto max-w-6xl px-4 py-14">
          <div className="max-w-2xl" data-reveal>
            ...
            <p className="mt-3 text-sm text-slate-600">{extraContent.about_intro}</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
            ...
            <div className="grid gap-5" data-reveal>
              <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                ...
                <p className="mt-2 text-sm text-slate-600">{missionVision.vision}</p>
              </div>
              <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                <h3 className="text-base font-extrabold text-brand-goldText">Mission</h3>
                <p className="mt-2 text-sm text-slate-600">{missionVision.mission}</p>
              </div>
            </div>
          </div>
            ...
            <div data-reveal>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {(extraContent.core_values || []).map((v) => (
                  <span
                    key={v}
                    className="inline-flex items-center rounded-full bg-brand-sky px-3 py-1 text-xs font-semibold text-brand-goldText ring-1 ring-slate-200"
                  >
                    {v}
                  </span>
                ))}
          ...
          <div
            className="mt-12 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200"
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">{extraContent.principal_message}</p>
                <p className="mt-3 text-xs font-semibold text-slate-500">— School Principal</p>
              </div>
            </div>
          </div>

          <div className="mt-12" data-reveal>
            <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white via-brand-sky/35 to-white p-6 shadow-sm ring-1 ring-white/70">
              ...
              {loading ? (
                <div className="relative mt-6 flex items-center gap-3 rounded-xl border border-dashed border-slate-200/80 bg-white/70 p-4 text-sm font-semibold text-slate-600 shadow-sm">
