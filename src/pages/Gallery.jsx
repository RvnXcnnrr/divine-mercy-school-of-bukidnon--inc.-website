  ...
  return (
    <div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-14">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between" data-reveal>
            <div>
              ...
              <p className="mt-3 text-sm text-slate-600">Browse images and media from our galleries.</p>
            </div>
      ...
      <div className="w-full overflow-hidden bg-brand-sky leading-none" aria-hidden="true">
        <svg className="block h-8 w-full fill-current text-white sm:h-10" viewBox="0 0 1440 80" preserveAspectRatio="none" focusable="false">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          {isError ? <p className="text-sm text-rose-600">Failed to load gallery.</p> : null}
          {isLoading ? <p className="text-sm text-slate-600">Loading images…</p> : null}
            ...
            {galleryItems.length ? (
              galleryItems.map((item) => (
                <button
                  ...
                  className="group relative overflow-hidden rounded-xl bg-slate-100 ring-1 ring-slate-200 transition hover:-translate-y-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold"
                >
              ...
              <p className="text-sm text-slate-600">No media yet. Upload via the admin panel.</p>
            )}
          </div>
        </div>
      </section>
