  ...
  return (
    <div>
      <section>
        <div className="mx-auto max-w-6xl px-4 py-14">
          <div className="max-w-2xl" data-reveal>
            ...
            <p className="mt-3 text-sm text-slate-600">Stay updated with upcoming school events.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          {isError ? <p className="text-sm text-rose-600">Failed to load events.</p> : null}
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {items.length ? (
              ...
              <p className="text-sm text-slate-600">No events yet. New schedules will appear here.</p>
            )}
          </div>
        </div>
      </section>
